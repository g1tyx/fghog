...
var cnItems = {
    ...
    "In this page, you can construct buildings to extract resources. By clicking on the desired building, you can see more details about it.": "在此页面中，您可以建造建筑物以提取资源。 通过单击所需的建筑物，您可以查看有关它的更多详细信息。",
    "Interstellar Travel": "星际旅行",
    "Laboratory": "实验室",
    "Let's extract Iron": "让我们提取铁",
    "Level up": "升级",
    "Locked": "未解锁",
    "Lvl": "等级",
